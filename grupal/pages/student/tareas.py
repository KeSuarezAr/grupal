...
def tareas_page() -> rx.Component:
    ...
    grades = [
        ["Tarea de Matemáticas", "Tarea", "16 Abr, 2023", 85],
        ["Presentación en Inglés", "Presentación", "14 Abr, 2023", 78],
        ["Proyecto de Ciencia", "Proyecto", "12 Abr, 2023", 65],
    ]
    ...
    def grade_card(name, category, date, grade):
        metadata = {"Date": date, "Calification": grade}
        return create_card(name, category, metadata)
