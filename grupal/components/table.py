...
from grupal.backend.backend import State, Customer
from grupal.components.form_field import form_field
from grupal.components.status_badges import status_badge
from grupal.models.assignmsent_model import Assignmsent
                ...
                rx.form.root(
                    rx.flex(
                        ...
                        form_field(
                            ...
                            input_type="number",
                            field_name="payments",
                            field_value=user.payments.to(str),
                        ),
                        # Status
                        rx.vstack(
                            rx.hstack(
                ...
                rx.form.root(
                    rx.flex(
                        ...
                        form_field(
                            ...
                            field_value=assignment.academic_year,
                        ),
                        # Asignatura
                        form_field(
                            label="Asignatura",
                            ...
                            input_type="text",
                            field_name="subject",
                            field_value=assignment.subject,
                        ),
                        # Paralelo
                        form_field(
                            label="Paralelo",
                            ...
                            input_type="text",
                            field_name="parallel",
                            field_value=assignment.parallel,
                        ),
                        # Trimestre
                        form_field(
                            label="Trimestre",
                            ...
                            field_value=assignment.trimester,
                        ),
                        # Tipo de Trabajo
                        form_field(
                            ...
                            field_value=assignment.work_type,
                        ),
                        # Tipo de Asignación
                        form_field(
                            ...
                            field_value=assignment.assignment_type,
                        ),
                        direction="column",
                        spacing="3",
                    ),
