...
class State(rx.State):
    ...
    def get_current_month_values(self):
        ...
        self.current_month_values = MonthValues(num_customers=num_customers, total_payments=total_payments,
    ...
    def get_previous_month_values(self):
        ...
        self.previous_month_values = MonthValues(num_customers=num_customers, total_payments=total_payments,
                                                 num_delivers=num_delivers)
    ...
    def add_customer_to_db(self, form_data: dict):
        ...
        with rx.session() as session:
            ...
            session.commit()
        self.load_entries()
        return rx.toast.info(f"User {self.current_user['name']} has been added.", variant="outline",
    ...
    def update_customer_to_db(self, form_data: dict):
        ...
        with rx.session() as session:
            ...
            session.commit()
        self.load_entries()
        return rx.toast.info(f"User {self.current_user['name']} has been modified.", variant="outline",
                             position="bottom-right")
    ...
    def payments_change(self) -> float:
        return _get_percentage_change(self.current_month_values.total_payments,
