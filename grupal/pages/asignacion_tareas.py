...
def asignar_tarea_page() -> rx.Component:
    return rx.box(
        ...
        rx.text_area(placeholder="Descripción de la tarea", width="100%", height="150px", margin_bottom="1em",
        ...
        rx.button(background="#333", color="white", width="100%", margin_bottom="1em",
                  on_click=TaskState.publicar_tarea),
        rx.button("Cancelar", variant="outline", width="100%", border_color="#333", color="#333",
                  on_click=lambda: rx.redirect("/dashboard_docente")),
        width="50%",
        margin="auto",
        padding="2em",
        border_radius="10px",
