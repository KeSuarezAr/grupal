...
def materias_page() -> rx.Component:
    ...
    def grades_table():
        return rx.cond(
            ...
            rx.box(
                rx.text(f"Calificaciones para {GradeState.selected_subject}", font_size="1.5em", font_weight="bold",
                        color="#FFFFFF", margin_bottom="1em"),
                rx.grid(
                    rx.grid(
            ...
            rx.text("Seleccione una materia para ver las calificaciones", font_size="1.5em", color="#FFFFFF",
                    text_align="center", margin_top="2em")
        )
